...
import { InputWithButton, Icon, Alert } from 'watson-react-components/dist/components'
...
export class AlertExample extends Component {
  constructor(props) {
    super(props)

    this.state = {
      match: props.match,
      params: "AAPL",  // In this version of React Router, it doesn't parse QSP
      error: false,
      loading: false,
